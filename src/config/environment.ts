...
const envVarsSchema = Joi.object({
  ...
  SPACES_ACCESS_KEY_ID: Joi.string().when('STORAGE_PROVIDER', { is: 'spaces', then: Joi.required() }),
  SPACES_SECRET_ACCESS_KEY: Joi.string().when('STORAGE_PROVIDER', { is: 'spaces', then: Joi.required() }),
